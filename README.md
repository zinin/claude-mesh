...
own test suite does not fit: `skills/shared/tests/` runs 188 s end to end (2026-08-30, thirteen
suites, 1137 assertions — `test-preflight-env.sh` 113 s, `test-config-loader.sh` 50 s,
