...
**YOUR FIRST ACTION must be to invoke the `gemini-code-review` skill using the Skill tool.**
...
- Do NOT run gemini commands directly — the skill chain handles execution
